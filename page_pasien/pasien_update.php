...
$result = mysqli_query($connectdb, "SELECT * FROM tbl_pasien WHERE medrec = $id");
if ($result->num_rows == 0) {
    die("Data tidak ditemukan.");
}

$du = $result->fetch_assoc();
                ...
                <div class="row row-sm mg-b-20">
                    <div class="col-lg-5 ht-lg-100p">
                        <div class="card card-table-one">
                            ...
                            <form action="../page_pasien/update_aksi.php" method="POST">
                                <input class="form-control" type="text" name="medrec" value="<?php echo $du['medrec']; ?>" hidden>

                                <div class="az-content-label mg-b-5">Nama Lengkap</div>
                                <div class="row row-sm mg-t-20">
                                    <div class="col-lg-7 mg-t-10 mg-lg-t-0">
                                        <input class="form-control" type="text" name="nm_pasien" value="<?php echo $du['nm_pasien']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row row-sm mg-t-20">
                                    <div class="col-lg-7 mg-t-10 mg-lg-t-0">
                                        <input class="form-control" type="text" name="tmp_lhr" value="<?php echo $du['tmp_lhr']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row row-sm mg-t-20">
                                    <div class="col-lg-7 mg-t-10 mg-lg-t-0">
                                        <input class="form-control" type="date" name="tgl_lhr" value="<?php echo $du['tgl_lhr']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row mg-t-10">
                                    <div class="col-lg-3">
                                        <label class="rdiobox">
                                            <input name="jnskel" type="radio" value="L" <?php if ($jnskel == 'L') echo 'checked'; ?>>
                                            <span>Pria</span>
                                        </label>
                                    </div><!-- col-3 -->
                                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                                        <label class="rdiobox">
                                            <input name="jnskel" type="radio" value="P" <?php if ($jnskel == 'P') echo 'checked'; ?>>
                                            <span>Wanita</span>
                                        </label>
                                    </div><!-- col-3 -->
                                </div>
                                ...
                                <div class="row row-sm mg-t-20">
                                    <div class="col-lg-7 mg-t-10 mg-lg-t-0">
                                        <!--Dekripsi NIK untuk ditampilkan ke form input type=text untuk diubah/update-->
                                        <?php
                                        ...
                                        $ciphertext = $du['ctext'];
                                        // Dekripsi
                                        list($ciphertext, $iv) = explode('::', base64_decode($du['nik']), 2);
                                        $dekripsi = openssl_decrypt($ciphertext, 'aes-256-cbc', $kunci, 0, $iv);
                                        ?>
                                        <input class="form-control" type="text" name="nik" value="<?php echo $dekripsi; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row row-sm mg-t-20">
                                    <div class="col-lg-7 mg-t-10 mg-lg-t-0">
                                        <input class="form-control" type="text" name="nohp" value="<?php echo $du['nohp']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row row-sm mg-t-20">
                                    <div class="col-lg-7 mg-t-10 mg-lg-t-0">
                                        <input class="form-control" type="textarea" name="alamat" value="<?php echo $du['alamat']; ?>">
                                    </div>
                                </div>
                                <div class="row row-sm mg-t-20">
                                    <div class="col-lg-7 col-md-3 mg-t-10 mg-sm-t-0"><button class="btn btn-az-secondary btn-block" type="submit">Ubah Data</button></div>
                                </div>
                            </form>
                        </div><!-- col -->
                    </div><!-- row -->
                    <div class="col-lg-7 mg-t-20 mg-lg-t-0">
                        ...
                        <!--Table untuk menampilkan data yang telah tersimpan di table pasien-->
                        <div class="card card-table-one">
